<?php include('phpSessionGesTech.php');
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
          ...
          <div class="content">
            ...
            <div class="container">
                <form method="post" action="">
                    <input type="search" name="motcletech" placeholder="Recherche par Nom">
  ...
  if($result)
  {
        while($row=mysqli_fetch_assoc($result))
        {
            ...
            <td>
            <a href="UpdateTech2.php?updateid='.$matriculetech.'" class="text-light">
            <img src="stylo.png" width=30px>
            
            </td>
            <td>
            <a href="deleteemp.php?deleteid='.$matriculetech.'" class="text-light">
