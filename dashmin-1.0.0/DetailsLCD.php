...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
     ...
     <h4>Tableau de recherche LCD</h4>
            </div>
            ...
            <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            $rechLCD=$_SESSION['motrechsessionLCD'];
                            $sql="Select * from `afficheur_lcd` where taille like '$rechLCD%'";
                            ...
                            else
                            {
                                ...
                                $alert="Aucun LCD ne correspend à la recherche !";
                                echo '</tbody></table>';
                                echo '
