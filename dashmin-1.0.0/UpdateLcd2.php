...
<?php
    include 'Config.php';
    $ref=$_GET['updateid'];
    $sql="Select * from `afficheur_lcd` where REFERENCE='$ref'";
    ...
    if(isset($_POST['modifier']))
    {
        ...
        $taille=$_POST['taille'];
        $req = "UPDATE afficheur_lcd SET  TAILLE='$taille' where REFERENCE='$ref'";
        if ($conn->query($req) === TRUE) {
            echo "La modification a été bien effectuer: ".$taille."-".$ref."-".$nom."-".$reference."-".$matriculetech;
            ...
            <div class="container my-5">
                <form method="post">
                    <div class="form-group">
                        <label for="REF">Reference LCD :</label>
                        <input type="text" class="form-control" name="reference"  value=<?php echo $refe;?>>
                    </div>
                    <div class="form-group">
                        <label for="TAI">taille :</label>
                        <input type="number" class="form-control" name="taille" value=<?php echo $ta;?>>
                    </div>
