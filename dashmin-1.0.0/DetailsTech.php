...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
     ...
     <h4>Tableau de recherche Technicien</h4>
            </div>
  ...
  <?php
    $rech=$_SESSION['motrechsessiontech'];
    $sql="Select * from `technicien` where nom_tech like '$rech%'";
    ...
    {        
        ...
        $alert="Aucun Technicien ne correspend à la recherche !";
                echo '</tbody></table>';
                echo '
