...
<?php
    ...
    if(isset($_POST['ajouter']))
    {
        ...
        $taille=$_POST['taille'];
        $req = "INSERT INTO afficheur_lcd VALUES ('$reference', '$taille')";
...
?>
    ...
    <div class="navbar-nav align-items-center ms-auto">
        <div class="nav-item dropdown">
            ...
            <!-- Début Formulaire Ajouter LCD -->
            <div class="container my-5">
                <form method="post">
                    <div class="form-group">
                        <label for="Reference">Reference LCD :</label>
                        <input type="text" class="form-control" name="reference" placeholder="Entrer la reference">
        
                    </div>
                    <div class="form-group">
                        <label for="Taille">Taille LCD :</label>
                        <input type="text" class="form-control" name="taille" placeholder="Entrer la taille">
                    </div>
                    <button type="submit" class="btn btn-primary" name="ajouter">Ajouter</button>
                </form>
            </div>
            <!-- Fin Formulaire Ajouter LCD -->
