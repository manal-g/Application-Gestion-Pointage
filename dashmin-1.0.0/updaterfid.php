...
<?php
    ...
    $coder=$_GET['updateid'];
    $sql="Select * from `rfid` where CODE_ETIQUETTE='$coder'";
    ...
    if(isset($_POST['modifier']))
    {
        ...
        $req = "UPDATE rfid SET  DESIGNATION='$designation' where CODE_ETIQUETTE='$coder'";
        if ($conn->query($req) === TRUE) {
            echo "La modification a été bien effectuer: ".$designation;
...
?>
    ...
    <div class="navbar-nav align-items-center ms-auto">
        <div class="nav-item dropdown">
            ...
            <!-- Début Formulaire Modifier RFID -->
            <div class="container my-5">
                <form method="post">
                    <div class="form-group">
                        <label for="code">Code RFID:</label>
                        <input type="text" class="form-control" name="coderfid"  value=<?php echo $coderfid;?>>
                    </div>
                    <div class="form-group">
                        <label for="TAI">Designation :</label>
                        <select  class="form-control" name="designation" value=<?php echo $desi;?>>
