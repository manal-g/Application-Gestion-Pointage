...
<body>
    <?php
        ...
        if(isset($_POST['ajouter']))
        {
            ...
            $email=$_POST['email'];
            $mdp=$_POST['mdp'];
            $req = "INSERT INTO administrateur VALUES ('$matricule_adm', '$nom', '$prenom', '$email', '$mdp')";
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
       ...
       <div class="sidebar pe-4 pb-3">
        ...
        <div class="content">
            ...
            <!-- Début Formulaire Ajouter Administrateur -->
            <div class="container my-5">
                <form method="post" >
                    <div class="form-group">
                    <label for="MatriculeAdm">Matricule Administrateur :</label>
                    <input type="text" class="form-control" name="matricule_adm" placeholder="Entrer le matricule">
                    </div>
                    <div class="form-group">
                ...
                <!-- Fin Formulaire Ajouter Administrateur -->
